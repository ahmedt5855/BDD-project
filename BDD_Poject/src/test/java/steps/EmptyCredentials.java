...
public class EmptyCredentials extends BaseTest {
...
@When("I entered empty password {string} ,{string}")
public void i_entered(String username, String password) {
    ...
    public void the_home_page_is_displayed() {
      ...
      String Emptyusername =   driver.findElement(loginObject.usertxt).getAttribute("value");
      String EmptyPassword = driver.findElement(loginObject.passtxt).getAttribute("value");
      if(EmptyPassword.contains(" ")) {
          Assert.assertEquals(loginObject.Required_password(driver), "Required");
      }
        if(EmptyPassword.contains(" ")) {
            Assert.assertEquals(loginObject.Required_username(driver), "Required");
        }
    }
